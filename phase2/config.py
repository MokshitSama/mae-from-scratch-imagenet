class CFG:
    ...
    n_splits = 10
    FOLD = 0
    batch_size = 192                        # per-GPU micro-batch (was 128; encoder sees only 25% patches, room on 32GB)
    num_workers = 8
    ...
    drop_path = 0.1
    ema_decay = 0.9999
    acc_steps = 4                           # was 5; 192*6*4 = 4608 eff_batch, ~half the micro-batches of before
